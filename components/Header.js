      ...
      <div className='flex gap-24 items-center'>
        ...
        <div className='flex gap-6 items-center'>
          {headerMenu.map((item,index)=>( 
            <div className={`flex gap-2 items-center  p-2 hover:cursor-pointer rounded-md hidden lg:block ${index==Hactive?`bg-grey-500 border-[1px] shadow-md border-black-400`:null} `}  onClick={()=>setHactive(index)}>
